...
//                   <FaUsers className="text-default-300" />
//                 </Button>
//               </DropdownTrigger>
//               <DropdownMenu>
...
//                 <Button endContent={<FaUsers className="text-small" />} variant="flat">
//                   Status
//                 </Button>
//               </DropdownTrigger>
//               <DropdownMenu
...
//               </DropdownMenu>
//             </Dropdown>
//             <Button color="primary" /* endContent={<FaUsers />} */>
//             <TfiPlus size={20}/>
//               Usuario
//             </Button>
//           </div>
...
//   return (
//     <div className="mt-2 ml-5 w-[820px]">
//       <Table
...
//     //   }}
//     classNames={{
//         wrapper: "h-[390px] max-h-[500px] w-[800px]  overflow-y-auto",
//       }}
      ...
      <div className="flex flex-col gap-1 w-full ">
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button className="bg-[#8bddbc] text-md" /* color="primary"  *//* endContent={<FaUsers />} */>
            <TfiPlus size={20}/>
              Usuario
            </Button>
          </div>
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">Total {usuarios.length} users</span>
          <label className="flex items-center text-default-400 text-small">
            Rows per page:
            <select
              className="bg-transparent outline-none text-default-400 text-small"
